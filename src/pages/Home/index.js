...
import React, { useEffect, useState } from 'react';
import { ActivityIndicator, FlatList, Text, View, StyleSheet, StatusBar, ScrollView} from 'react-native';
import Header from '../../components/Header'
          ...
          renderItem={({ item }) => (
            <View>
                <ScrollView style={styles.contentWrapper}>
                    ...
                    <Text style={{fontSize:18, color:'#f2f2f2'}}>{item.negatif_post}</Text>   
                </ScrollView>
            </View>
          )}
        />
